...
class ModelManager
{
    ...
    public function __construct()
    {
        ...
        { //conection to the data base
            $this->bdd = new PDO('mysql:host=db.3wa.io;dbname=mohammedhas_portfolios;charset=utf8', 'mohammedhas', '46dfb784fbe065d8922b515a40a0dbe2');
            /* $this->bdd = new PDO('mysql:host=localhost;dbname=portfolios;charset=utf8', 'root', ''); */
